...
<body>
    <div class="hero">
        <div class="hero-content">
            ...
            <form action="proxy.php" method="GET" id="proxy-form" class="search-box">
            ...
            <div class="recently-visited">
                ...
                <div class="site-buttons">
                    <a href="proxy.php?url=https://www.google.com" class="site-button">Google</a>
                    <a href="proxy.php?url=https://www.wikipedia.org" class="site-button">Wikipedia</a>
                    <a href="proxy.php?url=https://www.reddit.com" class="site-button">Reddit</a>
                    <a href="proxy.php?url=https://news.ycombinator.com" class="site-button">Hacker News</a>
                </div>
            </div>
        </div>
    </div>
